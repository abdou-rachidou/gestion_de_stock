...
class Menu:
    def __init__(self, root, longueur, largeur, main_instance):
        self.root = root
        self.main = main_instance  # Passer l'instance de la classe Main
        ...
        # Ajouter un titre
        titre_label = ttk.Label(root, text="Gestion des stocks", font=("Times New Roman", 35))
        titre_label.pack(pady=25)

        # Ajouter des options de menu avec des boutons carrés
